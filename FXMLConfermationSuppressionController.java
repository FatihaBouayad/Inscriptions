...
public class FXMLConfermationSuppressionController implements Initializable {
    ...
    ModeleInscriptionsStatic CurrentFournisseurStatic = new ModeleInscriptionsStatic();

    @FXML
    private void SupprimerCondidat() {
        try {
            String sql = "DELETE  FROM `inscription`  WHERE IDInscription ='" + CurrentFournisseurStatic.getIdInscription()+ "'";
